...
<?php  echo  ShopListing::widget() ?>
        ...
        <!-- details -->
<!--        <div class="row">-->
<!--            <div class="col-md-3 col-sm-6 main-shop-side wow zoomIn">-->
<!--                <div class="shop-container">-->
<!--                    <div class="img-container">-->
<!--                        <a href="details.php">-->
<!--                            <img src="img/shop-img.jpg" class="img-responsive" alt="shop image">-->
<!--                            <div class="shop-info">-->
<!--                                <h2><i class=""></i>Jwellary shop</h2><span class="price"><sup>$</sup>39</span>-->
<!--                            </div>-->
<!--                        </a>-->
<!--                    </div>-->
...
<!---->
<!--        <div class="container">-->
<!--            <ul class="pagination col-offset-sm-3">-->
